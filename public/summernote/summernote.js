...
var Dropzone = /*#__PURE__*/function () {
  function Dropzone(context) {
    ...
    this.$dropzone = external_jQuery_default()(['<div class="note-dropzone">', '<div class="note-dropzone-message.php"></div>', '</div>'].join('')).prependTo(this.$editor);
  }
  /**
  ...
  Dropzone_createClass(Dropzone, [{
    ...
    value: function attachDragAndDropEvent() {
      ...
      var $dropzoneMessage = this.$dropzone.find('.note-dropzone-message.php');
      ...
      this.$eventListener.on('dragenter', this.documentEventHandlers.onDragenter).on('dragleave', this.documentEventHandlers.onDragleave).on('drop', this.documentEventHandlers.onDrop); // change dropzone's message.php on hover.
